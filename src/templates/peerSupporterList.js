...
import PeerSupportersList from "../components/peer-supporters/list"
...
const PeerSupportersTemplate = ({ data, location, language }) => {
  ...
  return (
    <>
      ...
      `}
        ...
        />
        <PeerSupportersList data={data} location={location} language={language} />
      </Layout>
    </>
  )
}
